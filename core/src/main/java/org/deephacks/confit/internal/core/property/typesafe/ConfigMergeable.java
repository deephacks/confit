...
public interface ConfigMergeable {
     ...
     * href="https://github.com/typesafehub/typesafe/blob/master/HOCON.md">spec
     * for HOCON</a>. Merging typically occurs when either the
     * same object is created twice in the same file, or two
     * typesafe files are both loaded. For example:
     * <pre>
     *  foo = { a: 42 }
     *  foo = { b: 43 }
     * </pre>
     ...
     *            present in this one
     * @return a new object (or the original one, if the fallback doesn't lookup
     *         used)
     */
