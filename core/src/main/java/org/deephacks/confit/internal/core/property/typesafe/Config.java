 ...
 *
 * <p>
 * If you want to iterate over the contents of a {@code Config}, you can lookup its
...
public interface Config extends ConfigMergeable {
     ...
     * the root of the typesafe and the subtree will have no way to lookup values
     ...
     * the other getters. Use {@code lookup()} on the {@link
