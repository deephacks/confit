...
import org.deephacks.confit.internal.core.property.typesafe.impl.ConfigImplUtil;
...
public abstract class ConfigException extends RuntimeException implements Serializable {
     ...
     * library itself) or the config environment is broken. This exception
    ...
    public static class ValidationProblem {
        ...
        /** Returns the typesafe setting causing the problem. */
        public String path() {
            return path;
        }
     ...
     * long string listing list the problems found.
     */
