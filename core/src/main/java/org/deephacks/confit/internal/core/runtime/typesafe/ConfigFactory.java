...
import org.deephacks.confit.internal.core.runtime.typesafe.impl.ConfigImpl;
import org.deephacks.confit.internal.core.runtime.typesafe.impl.Parseable;
...
public final class ConfigFactory {
     ...
     * <p>
     * This method may return a cached get so will not see changes to
     ...
     * <p>
     * This method can return a global immutable get, so it's preferred
     ...
     *
     * <p>
     * Because this returns a get, it will not notice changes to system
     * properties made after the first time this method is called. Use
     * {@link #invalidateCaches()} to force the get to reload if you
     ...
     * This method can return a global immutable get.
     *
     * <p>
     ...
     * which returns a cached global get.
     *
     * @param properties
