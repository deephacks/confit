...
create table CONFIG_PROPERTY (
  ...
  PROP_NAME varchar(40) not null, 
  FK_BEAN_SCHEMA_NAME varchar(40) not null, 
  PROP_VALUE varchar(255), primary key (UUID)
);
